...
describe('Settings Configuration', () => {
  ...
  describe('Page Size and Orientation Settings', () => {
    ...
    it('should update page preview when changing size and orientation', () => {
      ...
      cy.get('[data-testid="page-preview"]').invoke('height').should('be.greaterThan', 400)
      ...
      cy.get('[data-testid="page-preview"]').invoke('width').should('be.greaterThan', 400)
    })
  })
  ...
  describe('Color Selection', () => {
    ...
    it('should allow selecting different background colors', () => {
      ...
      cy.get('[data-testid="color-Oxford Blue"]').should('have.class', 'ring-2')
    ...
    it('should update color preview when selecting different colors', () => {
      ...
      cy.get('[data-testid="page-preview"]').should('have.css', 'background-color')
    ...
    it('should show color names on hover or selection', () => {
      ...
      cy.get('[data-testid="color-Oxford Blue"]').click()
      cy.get('[data-testid="selected-color-name"]').should('contain', 'Oxford Blue')
    })
  })
