...
describe('PDF Generation and Download', () => {
  ...
  describe('PDF Generation with Different Layouts', () => {
    it('should generate PDF with Classic layout', () => {
      ...
      cy.get('[data-testid="current-design-style"]').should('contain', 'Classic')
  ...
  describe('PDF Generation Performance', () => {
    ...
    it('should optimize images during PDF generation', () => {
      ...
      cy.get('[data-testid="optimization-status"]').should('contain', 'Optimizing images')
  ...
  describe('PDF Generation Error Handling', () => {
    it('should handle empty pages gracefully', () => {
      ...
      cy.verifyToastMessage('Please add images to pages before generating PDF', 'error')
    })
    ...
    it('should handle generation errors gracefully', () => {
      ...
      cy.get('[data-testid="pdf-error-message"]', { timeout: 30000 })
        .should('contain', 'Error generating PDF')
    })
    ...
    it('should recover from generation failures', () => {
      ...
      cy.window().then((win) => {
        ...
        cy.stub(win, 'generatePDF').onFirstCall().throws(new Error('Test error'))
