...
describe('Auto-Arrangement Features', () => {
  ...
  describe('Global Auto-Arrangement', () => {
    ...
    it('should optimize layout for image aspect ratios', () => {
      ...
      cy.get('[data-testid="arrangement-quality-score"]').should('contain', '%')
    })
    ...
    it('should show progress during auto-arrangement', () => {
      ...
      cy.get('[data-testid="arrangement-status"]').should('contain', 'Arranging images')
      
      // Progress should complete
      cy.get('[data-testid="auto-arrange-progress"]', { timeout: 10000 }).should('not.exist')
  ...
  describe('Page-Level Auto-Arrangement', () => {
    ...
    it('should cycle through different layout patterns for a page', () => {
      ...
      cy.get('[data-testid="layout-pattern-indicator"]').should('contain', 'Layout 2')
      
      // Cycle again
      cy.nextLayout(0)
      cy.wait(500)
      
      cy.get('[data-testid="layout-pattern-indicator"]').should('contain', 'Layout 3')
    })
  ...
  describe('Randomization Features', () => {
    ...
    it('should randomize entire layout across all pages', () => {
      ...
      cy.get('[data-testid="randomizing-layout"]', { timeout: 5000 }).should('not.exist')
    ...
    it('should maintain page capacity constraints during randomization', () => {
      ...
      cy.get('[data-testid^="page-"]').each(($page, index) => {
        cy.wrap($page).within(() => {
          cy.get('[data-testid^="page-image-"]').should('have.length.lessThan', 3)
        })
      })
    })
  })
  ...
  describe('Layout Templates', () => {
    ...
    it('should adapt templates to available images', () => {
      ...
      cy.get('[data-testid="template-adaptation-warning"]')
        .should('contain', 'Template will be adapted for 3 images')
    ...
    it('should allow saving custom templates', () => {
      ...
      cy.get('[data-testid="template-description-input"]').type('Custom arrangement I created')
  ...
  describe('Performance and Edge Cases', () => {
    it('should handle large numbers of images efficiently', () => {
      ...
      cy.get('[data-testid="auto-arrange-progress"]', { timeout: 15000 }).should('not.exist')
  ...
  describe('Full Cover Mode Auto-Arrangement', () => {
    ...
    it('should auto-arrange for full cover layout', () => {
      ...
      cy.get('[data-testid^="page-"]').each(($page, index) => {
        cy.wrap($page).within(() => {
          ...
          cy.get('[data-testid^="page-image-"]').should('have.class', 'full-cover')
        })
      })
    })
    ...
    it('should cycle through cropping positions for full cover', () => {
      ...
      cy.get('[data-testid="crop-position-indicator"]').should('contain', 'Center')
      
      cy.get('[data-testid="page-0"]').within(() => {
        cy.get('[data-testid="cycle-crop-position-button"]').click()
      })
      
      cy.get('[data-testid="crop-position-indicator"]').should('contain', 'Top')
    })
  })
})